          ...
          <div className={styles.assistantMeta}>
            <div className={styles.assistantAvatar}>
              <svg viewBox="0 0 56 56" aria-hidden="true">
                ...
                <path d="M28 12v6M19 18l-3-3M37 18l3-3" stroke="#1e3257" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>
        ...
        <section className={styles.analysisGrid}>
          <article className={styles.infoCard}>
            ...
            <div className={styles.markdownBlock}>
              <p>
                设 <strong>y(x)=Σ[n=0→∞] aₙ (x - x₀)ⁿ</strong>，将其代入
                微分方程，若系数满足关于 <strong>aₙ</strong> 的递推关系，则可确定解的形式。
              </p>
          ...
          <article className={styles.chartCard}>
            ...
            <div className={styles.chartWrap}>
              <svg viewBox="0 0 360 250" className={styles.chartSvg} aria-hidden="true">
                ...
                <path d="M160 40C120 112 110 145 65 200" fill="none" stroke="#61d7c4" strokeWidth="2.8" strokeDasharray="10 8" />
                <path d="M240 72C214 126 176 136 86 182" fill="none" stroke="#ecc15a" strokeWidth="2.8" strokeDasharray="10 8" />
                <path d="M292 148C238 118 176 124 116 170" fill="none" stroke="#80b1ff" strokeWidth="2.8" strokeDasharray="10 8" />
                <path d="M60 148C98 102 134 96 172 120C202 138 234 170 290 110" fill="none" stroke="#4385ff" strokeWidth="3.4" />
                <path d="M180 196V204" stroke="#2f3b52" strokeWidth="1.8" />
                <text x="174" y="224" className={styles.axisText}>x₀</text>
                <text x="80" y="24" className={styles.axisText}>y</text>
                <text x="300" y="220" className={styles.axisText}>x</text>
                <g className={styles.legendText}>
                  <line x1="258" y1="38" x2="280" y2="38" stroke="#4385ff" strokeWidth="2.8" />
                  <text x="292" y="42">n = 1</text>
                  <line x1="258" y1="68" x2="280" y2="68" stroke="#61d7c4" strokeWidth="2.8" strokeDasharray="8 7" />
                  <text x="292" y="72">n = 2</text>
                  <line x1="258" y1="98" x2="280" y2="98" stroke="#ecc15a" strokeWidth="2.8" strokeDasharray="8 7" />
                  <text x="292" y="102">n = 3</text>
                  <line x1="258" y1="128" x2="280" y2="128" stroke="#80b1ff" strokeWidth="2.8" strokeDasharray="8 7" />
          ...
          <article className={styles.resourceCard}>
            ...
            <div className={styles.fileCard}>
              ...
              <button type="button" className={styles.downloadButton} aria-label="下载资料">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12 5v9m0 0 4-4m-4 4-4-4M6 17.5h12" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            </div>
            ...
            <div className={styles.previewCard}>
              <div className={styles.formulaPreview}>
                ...
                <span>y = ∑ aₙ (x - x₀)ⁿ</span>
              </div>
              <button type="button" className={styles.zoomButton}>查看大图</button>
            </div>
          </article>
        </section>
