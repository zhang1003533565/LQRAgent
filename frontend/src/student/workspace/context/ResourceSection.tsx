...
import { generateResource } from '@/student/api/resources'
import type { ResourceType } from '@/student/types/media-resource'
import { EmptyState, PlaceholderBanner } from '@/student/ui'
